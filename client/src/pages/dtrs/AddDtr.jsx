        ...
        <form className="w-full mx-auto py-5">
          <div className="flex gap-x-5">
            <div className="flex-1 mb-5">
                ...
                <input type="text" onChange={(e) => {setDtrNum(e.target.value)}} id="dtrNo" className={`bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ${errors.dtrNum ? 'border-red-400' : 'border-gray-300'}`}/>
            ...
            <div className="flex-1 mb-5">
                ...
                <DatePicker id='start' selected={startDate} onChange={(date) => setStartDate(date)} className={`bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ${errors.startDate   ? 'border-red-400' : 'border-gray-300'}`} />
            ...
            <div className="flex-1 mb-5">
                ...
                <DatePicker id="end" selected={endDate} onChange={(date) => setEndDate(date)} className={`bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ${errors.endDate   ? 'border-red-400' : 'border-gray-300'}`} />
